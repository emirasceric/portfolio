          ...
          <div className={this.getContainerClass()}>
            ...
            >
              ...
              <div className="additional-text ">
                <p className="text">
                  Over the past 3 years, I've been running a successful
                  dropshipping business as a side hustle, specializing
                  in difrent products, tools, home devices, chlothes... 
                  This hands-on experience has allowed me to
